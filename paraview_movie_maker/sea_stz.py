...
class ActiveView:
    ...
    def __init__(self, input_sl_dll_path, input_etopo_south_nc_path, input_seam_2d_nc_path,
        ...
        """Initialize the PIpeLine Object with Default Settings
            PipeLine
               ...
               │
               └─seam_2d.nc / netCDFReader() : sea 표층자료 READER
                        │
        ...
        self.seam_2d_nc_path = u'%s' % input_seam_2d_nc_path
        ...
        self.current_time_str = os.path.basename(self.seam_2d_nc_path).split(u'.')[0].split(u'_')[-1]
        ...
        self.etopo11nc.Dimensions = '(lat, lon)'
        ...
        self.renderView1.SetPropertyWithName("CenterOfRotation",
                                             [127.13333129882812, 31.52500057220459, -0.38132499158382416])

        self.text1 = Text()
        self.text1.Text = '왼쪽상단텍스트'
        self.text1Display = Show(self.text1, self.renderView1)
        self.text1Display.Color = [1.0, 1.0, 1.0]
        self.text1Display.WindowLocation = 'UpperLeftCorner'
        self.text1Display.FontFamily = 'File'
        self.text1Display.FontFile = self.time_font_ttf_path
        self.text1Display.FontSize = 10
        ...
        self.renderView1.CameraPosition = [128.45, 31.93333333333333, 10000.0]
        self.renderView1.CameraFocalPoint = [128.45, 31.93333333333333, 0.0]
        ...
        self.extractSubset1.VOI = [125, 1305, 265, 1420, 0, 0]
        ...
        self.extractSubset1Display.ColorArrayName = ['POINTS', 'Band1']
        self.extractSubset1Display.LookupTable = self.band1LUT
        self.extractSubset1Display.OSPRayScaleArray = 'Band1'
        self.extractSubset1Display.OSPRayScaleFunction = 'PiecewiseFunction'
        self.extractSubset1Display.SelectOrientationVectors = 'Band1'
        self.extractSubset1Display.ScaleFactor = 1.966666666666666
        self.extractSubset1Display.SelectScaleArray = 'Band1'
        self.extractSubset1Display.GlyphType = 'Arrow'
        self.extractSubset1Display.GlyphTableIndexArray = 'Band1'
        self.extractSubset1Display.GaussianRadius = 0.09833333333333329
        self.extractSubset1Display.SetScaleArray = ['POINTS', 'Band1']
        self.extractSubset1Display.ScaleTransferFunction = 'PiecewiseFunction'
        self.extractSubset1Display.OpacityArray = ['POINTS', 'Band1']
        ...
        self.threshold1.Scalars = ['POINTS', 'Band1']
        ...
        self.threshold1Display.ColorArrayName = ['POINTS', 'Band1']
        self.threshold1Display.LookupTable = self.band1LUT
        self.threshold1Display.OSPRayScaleArray = 'Band1'
        self.threshold1Display.OSPRayScaleFunction = 'PiecewiseFunction'
        self.threshold1Display.SelectOrientationVectors = 'Band1'
        self.threshold1Display.ScaleFactor = 1.9666656494140626
        self.threshold1Display.SelectScaleArray = 'Band1'
        self.threshold1Display.GlyphType = 'Arrow'
        self.threshold1Display.GlyphTableIndexArray = 'Band1'
        self.threshold1Display.GaussianRadius = 0.09833328247070312
        self.threshold1Display.SetScaleArray = ['POINTS', 'Band1']
        self.threshold1Display.ScaleTransferFunction = 'PiecewiseFunction'
        self.threshold1Display.OpacityArray = ['POINTS', 'Band1']
        ...
        self.calculator1.Function = 'coordsX*iHat+coordsY*jHat+kHat*Band1/1000*0.15'
        ...
        self.calculator1Display.ColorArrayName = ['POINTS', 'Band1']
        self.calculator1Display.LookupTable = self.band1LUT
        self.calculator1Display.OSPRayScaleArray = 'Band1'
        self.calculator1Display.OSPRayScaleFunction = 'PiecewiseFunction'
        self.calculator1Display.SelectOrientationVectors = 'Band1'
        self.calculator1Display.ScaleFactor = 1.9666656494140626
        self.calculator1Display.SelectScaleArray = 'Band1'
        self.calculator1Display.GlyphType = 'Arrow'
        self.calculator1Display.GlyphTableIndexArray = 'Band1'
        self.calculator1Display.GaussianRadius = 0.09833328247070312
        self.calculator1Display.SetScaleArray = ['POINTS', 'Band1']
        self.calculator1Display.ScaleTransferFunction = 'PiecewiseFunction'
        self.calculator1Display.OpacityArray = ['POINTS', 'Band1']
        ...
        self.threshold2.Scalars = ['POINTS', 'Band1']
        ...
        self.threshold2Display.ColorArrayName = ['POINTS', 'Band1']
        self.threshold2Display.LookupTable = self.band1LUT
        self.threshold2Display.OSPRayScaleArray = 'Band1'
        self.threshold2Display.OSPRayScaleFunction = 'PiecewiseFunction'
        self.threshold2Display.SelectOrientationVectors = 'Band1'
        self.threshold2Display.ScaleFactor = 1.9666656494140626
        self.threshold2Display.SelectScaleArray = 'Band1'
        self.threshold2Display.GlyphType = 'Arrow'
        self.threshold2Display.GlyphTableIndexArray = 'Band1'
        self.threshold2Display.GaussianRadius = 0.09833328247070312
        self.threshold2Display.SetScaleArray = ['POINTS', 'Band1']
        self.threshold2Display.ScaleTransferFunction = 'PiecewiseFunction'
        self.threshold2Display.OpacityArray = ['POINTS', 'Band1']
        ...
        self.calculator2.Function = 'coordsX*iHat+coordsY*jHat+kHat*Band1/10000'
        ...
        self.calculator2Display.ColorArrayName = ['POINTS', 'Band1']
        self.calculator2Display.LookupTable = self.band1LUT
        self.calculator2Display.OSPRayScaleArray = 'Band1'
        self.calculator2Display.OSPRayScaleFunction = 'PiecewiseFunction'
        self.calculator2Display.SelectOrientationVectors = 'Band1'
        self.calculator2Display.ScaleFactor = 1.9666656494140626
        self.calculator2Display.SelectScaleArray = 'Band1'
        self.calculator2Display.GlyphType = 'Arrow'
        self.calculator2Display.GlyphTableIndexArray = 'Band1'
        self.calculator2Display.GaussianRadius = 0.09833328247070312
        self.calculator2Display.SetScaleArray = ['POINTS', 'Band1']
        self.calculator2Display.ScaleTransferFunction = 'PiecewiseFunction'
        self.calculator2Display.OpacityArray = ['POINTS', 'Band1']
        ...
        # create a new 'NetCDF Reader'
        self.seam_2dnc = NetCDFReader(FileName=[self.seam_2d_nc_path])
        self.seam_2dnc.Dimensions = '(eta_rho, xi_rho)'
        ...
        # Properties modified on seam_2dnc
        self.seam_2dnc.SphericalCoordinates = 0

        # Get the Timestep Values from seam_2dnc
        self.seam_2dnc_TimeStepValues = sorted([ts for ts in self.seam_2dnc.TimestepValues])

        # get the Initial StartTime and EndTime Value from animationScene1
        self.animationScene1StartTime = min(self.seam_2dnc_TimeStepValues)
        self.animationScene1EndTime = max(self.seam_2dnc_TimeStepValues)
        self.animationScene1IntervalLen \
            = (float(self.animationScene1EndTime) - float(self.animationScene1StartTime)) \
              / (len(self.seam_2dnc_TimeStepValues) - 1)
        ...
        # show data in view
        self.seam_2dncDisplay = Show(self.seam_2dnc, self.renderView1)

        # trace defaults for the display properties.
        self.seam_2dncDisplay.Representation = 'Surface'
        self.seam_2dncDisplay.AmbientColor = [0.0, 0.0, 0.0]
        self.seam_2dncDisplay.ColorArrayName = [None, '']
        self.seam_2dncDisplay.OSPRayScaleArray = 'h'
        self.seam_2dncDisplay.OSPRayScaleFunction = 'PiecewiseFunction'
        self.seam_2dncDisplay.SelectOrientationVectors = 'None'
        self.seam_2dncDisplay.ScaleFactor = 1.9468032786887122
        self.seam_2dncDisplay.SelectScaleArray = 'None'
        self.seam_2dncDisplay.GlyphType = 'Arrow'
        self.seam_2dncDisplay.GlyphTableIndexArray = 'None'
        self.seam_2dncDisplay.GaussianRadius = 0.0973401639344356
        self.seam_2dncDisplay.SetScaleArray = ['POINTS', 'h']
        self.seam_2dncDisplay.ScaleTransferFunction = 'PiecewiseFunction'
        self.seam_2dncDisplay.OpacityArray = ['POINTS', 'h']
        self.seam_2dncDisplay.OpacityTransferFunction = 'PiecewiseFunction'
        self.seam_2dncDisplay.DataAxesGrid = 'GridAxesRepresentation'
        self.seam_2dncDisplay.SelectionCellLabelFontFile = ''
        self.seam_2dncDisplay.SelectionPointLabelFontFile = ''
        self.seam_2dncDisplay.PolarAxes = 'PolarAxesRepresentation'
        self.seam_2dncDisplay.ScalarOpacityUnitDistance = 0.3719322908004742
        self.seam_2dncDisplay.InputVectors = [None, '']

        # init the 'GridAxesRepresentation' selected for 'DataAxesGrid'
        self.seam_2dncDisplay.DataAxesGrid.XTitleColor = [0.0, 0.0, 0.0]
        self.seam_2dncDisplay.DataAxesGrid.XTitleFontFile = ''
        self.seam_2dncDisplay.DataAxesGrid.YTitleColor = [0.0, 0.0, 0.0]
        self.seam_2dncDisplay.DataAxesGrid.YTitleFontFile = ''
        self.seam_2dncDisplay.DataAxesGrid.ZTitleColor = [0.0, 0.0, 0.0]
        self.seam_2dncDisplay.DataAxesGrid.ZTitleFontFile = ''
        self.seam_2dncDisplay.DataAxesGrid.GridColor = [0.0, 0.0, 0.0]
        self.seam_2dncDisplay.DataAxesGrid.XLabelColor = [0.0, 0.0, 0.0]
        self.seam_2dncDisplay.DataAxesGrid.XLabelFontFile = ''
        self.seam_2dncDisplay.DataAxesGrid.YLabelColor = [0.0, 0.0, 0.0]
        self.seam_2dncDisplay.DataAxesGrid.YLabelFontFile = ''
        self.seam_2dncDisplay.DataAxesGrid.ZLabelColor = [0.0, 0.0, 0.0]
        self.seam_2dncDisplay.DataAxesGrid.ZLabelFontFile = ''

        # init the 'PolarAxesRepresentation' selected for 'PolarAxes'
        self.seam_2dncDisplay.PolarAxes.PolarAxisTitleColor = [0.0, 0.0, 0.0]
        self.seam_2dncDisplay.PolarAxes.PolarAxisTitleFontFile = ''
        self.seam_2dncDisplay.PolarAxes.PolarAxisLabelColor = [0.0, 0.0, 0.0]
        self.seam_2dncDisplay.PolarAxes.PolarAxisLabelFontFile = ''
        self.seam_2dncDisplay.PolarAxes.LastRadialAxisTextColor = [0.0, 0.0, 0.0]
        self.seam_2dncDisplay.PolarAxes.LastRadialAxisTextFontFile = ''
        self.seam_2dncDisplay.PolarAxes.SecondaryRadialAxesTextColor = [0.0, 0.0, 0.0]
        self.seam_2dncDisplay.PolarAxes.SecondaryRadialAxesTextFontFile = ''

        # update the view to ensure updated data information
        self.renderView1.Update()

        # create a new 'Extract Subset'
        self.extractSubset2 = ExtractSubset(Input=self.seam_2dnc)
        self.extractSubset2.VOI = [0, 609, 0, 641, 0, 0]
        ...
        # hide data in view
        Hide(self.seam_2dnc, self.renderView1)
        ...
        self.extractTimeSteps1.TimeStepRange = [0, len(self.seam_2dnc_TimeStepValues) - 1]
        ...
        self.renderView1.CameraPosition = [128.45, 31.93333333333333, 10000.0]
        self.renderView1.CameraFocalPoint = [128.45, 31.93333333333333, 0.0]
        self.renderView1.CameraParallelScale = 19.593968743241142
    ...
    def m00_02_01_set_view_graphics_land(self, input_land_colorbar_font_ttf_path,
        ...
        if dim == '3D':
            ...
            if len({'COLOR', 'color', 'C', 'c'}.intersection(params.keys())) == 1 \
                ...
                self.band1LUT = GetColorTransferFunction('Band1', self.threshold2Display)
                self.band1PWF = GetOpacityTransferFunction('Band1', self.threshold2Display)
                ...
                if False:
                    ColorBy(self.calculator2Display, ('POINTS', 'Band1'))
                    self.band1LUT = GetColorTransferFunction('Band1', self.calculator2Display)
                    self.band1PWF = GetOpacityTransferFunction('Band1', self.calculator2Display)
                ...
                if False:
                    ...
                    self.separate_calculator2Display_Band1LUT = \
                        GetColorTransferFunction('Band1', self.calculator2Display, separate=True)
                    self.separate_calculator2Display_Band1PWF = \
                        GetOpacityTransferFunction('Band1', self.calculator2Display, separate=True)
                    self.calculator2Display.RescaleTransferFunctionToDataRange(True, False)
                    ...
                    self.calculator2Display.SetScalarBarVisibility(self.renderView1, use_scalar_bar)
                if True:
                    ColorBy(self.calculator2Display, ('POINTS', 'Band1'), True)
                    self.band1LUT = GetColorTransferFunction('Band1', self.calculator2Display)
                    self.band1PWF = GetOpacityTransferFunction('Band1', self.calculator2Display)
                    self.calculator2Display.RescaleTransferFunctionToDataRange(True, False)
                    self.calculator2Display.Opacity = 1
                    self.band1LUT.RescaleTransferFunction(scale_min, scale_max)
                    self.band1PWF.RescaleTransferFunction(scale_min, scale_max)
                    self.band1LUT.ApplyPreset(palette_nm, True)  # sample5_land_topo_color
                    self.band1LUTColorBar = GetScalarBar(self.band1LUT, self.renderView1)
    ...
    def m00_02_02_set_view_graphics_ocean(self, input_ocean_colorbar_font_ttf_path, scale_min, scale_max,
        ...
        if dim == '2D':
            if params == dict():
                ...
                ColorBy(self.threshold1Display, ('POINTS', 'Band1'), True)
                self.separate_threshold1Display_Band1LUT = \
                    GetColorTransferFunction('Band1', self.threshold1Display, separate=True)
                self.separate_threshold1Display_Band1PWF = \
                    GetOpacityTransferFunction('Band1', self.threshold1Display, separate=True)
                    ...
                    if params[param] not in ['S', 'T', 'U', 'Z', 'V', 's', 't', 'u', 'z', 'v',
                        ...
                        if 'colormap_json_path' in params.keys() \
                            ...
                            if params[param] in ['S', 's', 'SALT', 'salt', 'T', 't', 'TEMP', 'temp',
                                ...
                                ColorBy(self.calculator1Display, None)
                                self.cal1LUT = GetColorTransferFunction('Band1', self.calculator1Display)
                                self.cal1PWF = GetOpacityTransferFunction('Band1', self.calculator1Display)
                            ...
                            self.band1LUT = GetColorTransferFunction('Band1', self.threshold1Display)
                            self.band1PWF = GetOpacityTransferFunction('Band1', self.threshold1Display)
                            self.threshold1Display.Ambient = ambient
    ...
    def m00_02_03_set_view_graphics_streamline(self, input_streamline_colorbar_font_ttf_path, scale_min=0,
        ...
        # calculator3Display ( Not Colored by Scalar ) ::: seam_2d.nc AREA ( StreamLine )
        ...
        if color_setting == 'UNIFORM':
            ...
            if len({'C', 'c', 'COLOR', 'color'}.intersection(set(params.keys()))) == 1 \
                    and type(params[list(params.keys())[0]]).__name__ in ['tuple', 'list'] \
                    and len(params[list(params.keys())[0]]) == 3 \
                    and sum([type(e).__name__ in ['int', 'float'] for e in params[list(params.keys())[0]]]) == 3:
                self.calculator3Display.DiffuseColor = params[list(params.keys())[0]]
            else:
    ...
    def m01_create_avi_by_time_steps(self, input_out_avi_dir, camera_setting="ENTIRE",
                                     nof_frames=100, fps=20):
        """Create .avi Format Movie Files for Each Time Steps"""

        self.renderView1.InteractionMode = '2D'
        if camera_setting == "ENTIRE":  # OK
            self.extractSubset1.VOI = [130, 1301, 271, 1410, 0, 0]  # etopo
            self.extractSubset2.VOI = [0, 609, 0, 641, 0, 0]  # sea
            self.renderView1.Update()
            self.renderView1.CameraPosition = [127.15, 31.5015, 10000]
            self.renderView1.CameraFocalPoint = [127.15, 31.5015, 0]
            self.renderView1.CameraViewUp = [0, 1, 0]
            self.renderView1.CameraViewAngle = 30
            self.renderView1.CameraParallelScale = 9.283
        elif camera_setting == "WEST":  # OK
            self.extractSubset1.VOI = [125, 800, 900, 1410, 0, 0]  # etopo
            self.extractSubset2.VOI = [0, 348, 338, 641, 0, 0]  # sea
            self.renderView1.Update()
            self.renderView1.CameraPosition = [123.058, 36.7075, 26.6839]
            self.renderView1.CameraFocalPoint = [123.058, 36.7075, 0]
            self.renderView1.CameraViewUp = [0, 1, 0]
            self.renderView1.CameraViewAngle = 30
            self.renderView1.CameraParallelScale = 4.28866
        elif camera_setting == "SOUTH":  # OK
            self.extractSubset1.VOI = [458, 1053, 742, 1130, 0, 0]  # etopo
            self.extractSubset2.VOI = [170, 480, 250, 470, 0, 0]  # sea
            self.renderView1.Update()
            self.renderView1.CameraPosition = [127.805, 33.0952, 22.835]
            self.renderView1.CameraFocalPoint = [127.805, 33.0952, 0]
            self.renderView1.CameraViewUp = [0, 1, 0]
            self.renderView1.CameraViewAngle = 30
            self.renderView1.CameraParallelScale = 3.32612
        elif camera_setting == "EAST":  # OK
            self.extractSubset1.VOI = [700, 1301, 950, 1410, 0, 0]  # etopo
            self.extractSubset2.VOI = [297, 609, 366, 641, 0, 0]  # sea
            self.renderView1.CameraPosition = [131.897, 37.1583, 24.291]
            self.renderView1.CameraFocalPoint = [131.897, 37.1583, 0]
            self.renderView1.CameraViewUp = [0, 1, 0]
            self.renderView1.CameraViewAngle = 30
            self.renderView1.CameraParallelScale = 3.98993
        else:  # OK
            self.extractSubset1.VOI = [130, 1301, 271, 1410, 0, 0]  # etopo
            self.extractSubset2.VOI = [0, 609, 0, 641, 0, 0]  # sea
            self.renderView1.Update()
        ...
        for ts in sorted(self.seam_2dnc_TimeStepValues):
            tsIdx = sorted(self.seam_2dnc_TimeStepValues).index(ts)
        ...
        # save animation
        for time_step in sorted(self.seam_2dnc_TimeStepValues):
            time_step_idx = self.seam_2dnc_TimeStepValues.index(time_step)

            if not (0 <= time_step_idx <= (len(self.seam_2dnc_TimeStepValues) - 1)):
                pass
            else:
    ...
    def m01_create_avi(self, input_out_avi_dir, camera_setting="ENTIRE",
        ...
        self.extractTimeSteps1.TimeStepRange = [0, len(self.seam_2dnc_TimeStepValues) - 1]
        self.animationScene1.StartTime = sorted(self.seam_2dnc_TimeStepValues)[0]
        self.animationScene1.EndTime = sorted(self.seam_2dnc_TimeStepValues)[-1]
        ...
        input_out_avi_path = \
            os.path.join(input_out_avi_dir, self.current_time_str,
                         u'sea_{}_{}{}.ogv'
                         .format(self.current_time_str,
                                 u'salt' if self.ocean_graphic == u'2D_SALT'
                                 ...
                                 "_" + camera_setting.lower() if camera_setting in ["WEST", "EAST", "SOUTH"]
                                 else ""
                                 ))
        if not os.path.exists(os.path.dirname(input_out_avi_path)):
            os.makedirs(os.path.dirname(input_out_avi_path))
    ...
    def m02_start_interactive_window(self, input_slider_ttf_path, use_time_step_slider=True):
        ...
        self.renderView1.CameraParallelScale = 13.7795
        ...
        self.interactor1_rw1.SetWindowName(os.path.basename(self.seam_2d_nc_path))
        ...
        if use_time_step_slider:
            ...
            self.sliderRep1.SetMinimumValue(min(self.seam_2dnc_TimeStepValues))
            self.sliderRep1.SetMaximumValue(max(self.seam_2dnc_TimeStepValues))
...
if __name__ == '__main__':
    ...
    ncs = [os.path.join(walk[0], nc)
           for walk in os.walk('/home/DATA/prc/sea') for nc in walk[2]
           if os.path.splitext(nc)[-1].lower() == '.nc'
           and os.path.splitext(nc)[0].split('_')[-1] == sys.argv[1]
           and os.path.basename(walk[0]) == sys.argv[1]
           and os.path.basename(os.path.dirname(walk[0])) == sys.argv[1][:len('2019')]]
    inputNc = ''
    if len(ncs) == 0:
        print('No nc File Matching DATE=\'%s\'' % sys.argv[1])
    elif len(ncs) > 1:
        print('Duplicated nc File Matching DATE=\'%s\'' % sys.argv[1])
    else:
        inputNc = ncs[0]
        print('nc >> %s' % inputNc)
        outDir = '/home/DATA/vid/sea/%s' % (sys.argv[1][:len('2019')])
        print('OUT >> %s' % outDir)

        activeView1 = \
            ActiveView(
                input_sl_dll_path="/usr/local/lib/paraview-5.6/plugins/StreamLinesRepresentation/libStreamLinesRepresentation.so",
                input_etopo_south_nc_path="/home/DATA/src/etopo11.nc",
                input_seam_2d_nc_path=inputNc,
                input_time_font_ttf_path='/home/DATA/src/fonts/NanumBarunGothicBold.ttf',
                use_time_label=True, input_view_size_h=1600, input_view_size_v=900,
            )
        ...
        activeView1.m00_02_01_set_view_graphics_land(
            ...
            input_land_colorbar_font_ttf_path='/home/DATA/src/fonts/NanumBarunGothic.ttf',
            colormap_json_path='/home/DATA/src/colormaps/sample5_land_topo_color.json'
        )
        activeView1.m00_02_02_set_view_graphics_ocean(
            dim='2D', var='salt', scale_min=26, scale_max=36, opacity=1,
            input_ocean_colorbar_font_ttf_path='/home/DATA/src/fonts/NanumBarunGothic.ttf',
            colormap_json_path='/home/DATA/src/colormaps/sample5_1_Salinity_Palette_1.json'
        )
        activeView1.m01_create_avi(input_out_avi_dir=outDir, camera_setting="ENTIRE", fps=1, nof_frames=73)
        activeView1.m01_create_avi(input_out_avi_dir=outDir, camera_setting="WEST", fps=1, nof_frames=73)
        activeView1.m01_create_avi(input_out_avi_dir=outDir, camera_setting="EAST", fps=1, nof_frames=73)
        activeView1.m01_create_avi(input_out_avi_dir=outDir, camera_setting="SOUTH", fps=1, nof_frames=73)
        # activeView1.m02_start_interactive_window(input_slider_ttf_path='/home/DATA/src/fonts/NanumBarunGothic.ttf')
        ...
        activeView1.m00_02_02_set_view_graphics_ocean(
            dim='2D', var='temp', scale_min=20, scale_max=33, opacity=1,
            input_ocean_colorbar_font_ttf_path='/home/DATA/src/fonts/NanumBarunGothic.ttf',
            colormap_json_path='/home/DATA/src/colormaps/sample5_1_Temperature_Palette_1.json'
        )
        activeView1.m01_create_avi(input_out_avi_dir=outDir, camera_setting="ENTIRE", fps=1, nof_frames=73)
        activeView1.m01_create_avi(input_out_avi_dir=outDir, camera_setting="WEST", fps=1, nof_frames=73)
        activeView1.m01_create_avi(input_out_avi_dir=outDir, camera_setting="EAST", fps=1, nof_frames=73)
        ...
        activeView1.m00_02_02_set_view_graphics_ocean(
            ...
            input_ocean_colorbar_font_ttf_path='/home/DATA/src/fonts/NanumBarunGothic.ttf',
            colormap_json_path='/home/DATA/src/colormaps/UVVelocity_color.json'
        )
        activeView1.m01_create_avi(input_out_avi_dir=outDir, camera_setting="ENTIRE", fps=1, nof_frames=73)
        activeView1.m01_create_avi(input_out_avi_dir=outDir, camera_setting="WEST", fps=1, nof_frames=73)
        activeView1.m01_create_avi(input_out_avi_dir=outDir, camera_setting="EAST", fps=1, nof_frames=73)
